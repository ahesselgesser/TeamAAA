...
def table_two_access(file_name, column, table, row_iter, data):
...
def table_three_access(column, table, row_iter, data):
...
def table_four_access(file_name, column, table, row_iter, data_coll_list):
    if (file_name == "undergrad2018-regularv2.docx" or file_name == "undergrad2019-regular.docx"):
        for row in table.rows:
